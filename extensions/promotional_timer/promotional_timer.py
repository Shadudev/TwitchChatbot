...
MESSAGES = [
    ...
    "Use your !glitches to choose what hat I shall wear for about an hour. Do !hats for the existing hats."
]
...
class PromotionalTimer(Timer):
    ...
    def get_message(self):
        self._last_chosen_index = choice(
            list(filter(lambda index: index != self._last_chosen_index, range(len(MESSAGES)))))
